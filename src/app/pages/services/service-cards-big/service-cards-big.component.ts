  ...
  services: ServiceCard[] = [
    {
      ...
      bgPos: 'right center',
      tags: ['Пакеты услуг по поступлению в вуз', 'Помощь в составлении резюме', 'Подбор и запись на стипендию', 'Заверенный перевод документов']
    },
    {
    ...
    },
    {
      ...
      tags: ['Студенческие резиденции', 'Аренда квартир', 'Проживание в семьях', 'Поиск гаранта во Франции', 'Первый визит к врачу']
    },
    {
